              ...
              onPressed: () {
                ...
                Navigator.pop(
                    ...
                    isInitiallyFavorited !=
                        userDoc!.isCompanyBookmarked(widget.company));
              },
            ),
          ),
                ...
                children: <Widget>[
                  FutureBuilder<String>(
                    ...
                    builder: (context, snapshot) {
                      String description =
                          snapshot.data ?? 'Description not available';
                      ...
                      builder: (context, snapshot) {
                          ...
                          switch (key) {
                            ...
                            default:
                              return key[0].toUpperCase() +
                                  key.substring(1); // Capitalize first letter
                          }
                        }
                        ...
                        String formatValue(String key, dynamic value) {
                          if (key == 'iso' && value is String) {
                            ...
                            // Format phone number
                            String rawNumber =
                                int.parse(double.parse(value).floor().toString()).toString();
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: Card(
                                    ...
                                    child: Column(
                                      mainAxisAlignment:
                                          widget.company.profile!.weburl != null
                                      ...
                                      children: [
                                        ...
                                        if (widget.company.profile!.weburl !=
                                                null &&
                                            widget.company.profile!.weburl!
                                                .isNotEmpty)
                                          Padding(
                                            padding:
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (await canLaunchUrl(_url)) {
                                                  ...
                                                  ScaffoldMessenger.of(context)
                                                    ...
                                                    SnackBar(
                                                        content: Text(
                                                            'Could not launch ${widget.company.profile!.weburl!}')),
                                                  );
                                                }
                                              },
                      ...
                      for (var filing in widget.company.secEdgar!.filings!) {
                        if (filing['form'] == '10-K' ||
                          ...
                          if (!filing.containsKey("url")) {
                            filing["url"] =
                                widget.company.secEdgar!.getFilingURL(filing);
                          }
